...
inst.time_release_delay=10;
	...
	if(time == 130){
			...
			var inst=instance_create_depth(0,10,0,battle_bullet_gb);
inst.x_target=battle_board.x+(battle_board.right/2);
inst.y_target=battle_board.y-battle_board.up-100;
inst.angle_start=-90;
inst.angle_target=-90;
inst.type=0;
...
aaaaa.toggle=1
				...
				bbbbb = instance_create_depth(battle_board.x+battle_board.right+200-18,y,0,battle_bullet_bone_gap_maker)
bbbbb.way=1
bbbbb.length_t=105
bbbbb.length_b=5
bbbbb.change_t=0
