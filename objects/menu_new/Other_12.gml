...
if(_mode==0){
	...
	event_user(1);
	_change_inst=_inst_changeurname;
	_change_color=(_choice==2 ? c_yellow : c_white);
	event_user(1);
	_change_inst=_inst_hardmode;
	_change_color=(_choice==3 ? c_red : c_white);
	event_user(1);
	_change_inst=_inst_return;
	_change_color=(_choice==4 ? c_yellow : c_white);
	event_user(1);
}else{
	...
	_inst_hardmode.override_color_text=(_choice==3 ? c_red : c_white);
}